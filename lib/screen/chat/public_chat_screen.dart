...
class PublicChatScreen extends ConsumerStatefulWidget {
  const PublicChatScreen({super.key});

  @override
  ConsumerState<PublicChatScreen> createState() => _PublicChatScreenState();
}

class _PublicChatScreenState extends ConsumerState<PublicChatScreen> {
